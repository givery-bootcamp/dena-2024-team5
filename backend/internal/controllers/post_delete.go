...
// @Tags posts
// @Success 204
// @Failure 400 {object} controllers.ErrorResponse	対象の投稿の作成者が自分ではない場合も400となる
// @Failure 500 {object} controllers.ErrorResponse
// @Router /posts/{postID} [delete]
func PostDelete(
	ctx *gin.Context,
	ownerUsecase *usecases.PostOwnerValidateUsecase,
	deleteUsecase *usecases.PostDeleteUsecase,
) {
